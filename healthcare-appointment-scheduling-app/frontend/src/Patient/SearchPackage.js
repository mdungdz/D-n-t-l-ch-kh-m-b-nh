...
const SearchPackage = () => {
  ...
  const labTestPackages = [
    { id: "XN01", name: "Xét nghiệm máu tổng quát cơ bản", type: "xet-nghiem", subType: "tong-quat", category: ["Xét nghiệm", "Tổng quát"], fee: 500000, img: nmdLogoo, vip: false },
    { id: "XN02", name: "Xét nghiệm vi chất & Vitamin cho cơ thể", type: "xet-nghiem", subType: "tong-quat", category: ["Xét nghiệm", "Tổng quát"], fee: 1200000, img: nmdLogoo, vip: true },
    { id: "XN03", name: "Lấy mẫu xét nghiệm tại nhà (Gói tiết kiệm)", type: "xet-nghiem", subType: "tai-nha", category: ["Xét nghiệm", "Tại nhà"], fee: 300000, img: nmdLogoo, vip: false },
    { id: "XN04", name: "Kiểm tra sức khỏe tại nhà toàn diện", type: "xet-nghiem", subType: "tai-nha", category: ["Xét nghiệm", "Tại nhà"], fee: 1500000, img: nmdLogoo, vip: true },
    { id: "XN05", name: "Tầm soát dấu ấn ung thư Nam giới (5 chỉ số)", type: "xet-nghiem", subType: "ung-thu", category: ["Xét nghiệm", "Ung thư"], fee: 1800000, img: nmdLogoo, vip: true },
    { id: "XN06", name: "Tầm soát dấu ấn ung thư Nữ giới (6 chỉ số)", type: "xet-nghiem", subType: "ung-thu", category: ["Xét nghiệm", "Ung thư"], fee: 2100000, img: nmdLogoo, vip: true },
    { id: "XN07", name: "Sàng lọc NIPT cơ bản (3 cặp NST)", type: "xet-nghiem", subType: "nipt", category: ["Xét nghiệm", "NIPT"], fee: 3500000, img: nmdLogoo, vip: false },
    { id: "XN08", name: "Sàng lọc NIPT chuyên sâu (23 cặp NST)", type: "xet-nghiem", subType: "nipt", category: ["Xét nghiệm", "NIPT"], fee: 6000000, img: nmdLogoo, vip: true },
    { id: "XN09", name: "Test nhanh NS1AG & Công thức máu", type: "xet-nghiem", subType: "sot-xuat-huyet", category: ["Xét nghiệm", "Truyền nhiễm"], fee: 450000, img: nmdLogoo, vip: false },
    { id: "XN10", name: "Gói theo dõi Sốt xuất huyết tại nhà", type: "xet-nghiem", subType: "sot-xuat-huyet", category: ["Xét nghiệm", "Truyền nhiễm"], fee: 900000, img: nmdLogoo, vip: false },
    { id: "XN11", name: "Xét nghiệm panel dị ứng 60 dị nguyên", type: "xet-nghiem", subType: "di-ung", category: ["Xét nghiệm", "Dị ứng"], fee: 1350000, img: nmdLogoo, vip: true },
    { id: "XN12", name: "Kiểm tra dị ứng thực phẩm chuyên biệt", type: "xet-nghiem", subType: "di-ung", category: ["Xét nghiệm", "Dị ứng"], fee: 800000, img: nmdLogoo, vip: false },
    { id: "XN13", name: "Kiểm tra chức năng Gan cơ bản", type: "xet-nghiem", subType: "gan", category: ["Xét nghiệm", "Gan mật"], fee: 400000, img: nmdLogoo, vip: false },
    { id: "XN14", name: "Xét nghiệm Viêm gan B, C chuyên sâu", type: "xet-nghiem", subType: "gan", category: ["Xét nghiệm", "Gan mật"], fee: 1100000, img: nmdLogoo, vip: true },
    { id: "XN15", name: "Test nhanh Cúm A/B & Cúm gia cầm", type: "xet-nghiem", subType: "cum-va-sot", category: ["Xét nghiệm", "Hô hấp"], fee: 350000, img: nmdLogoo, vip: false },
    { id: "XN16", name: "Combo Xét nghiệm Sốt virus chuyên sâu", type: "xet-nghiem", subType: "cum-va-sot", category: ["Xét nghiệm", "Hô hấp"], fee: 750000, img: nmdLogoo, vip: false },
    { id: "XN17", name: "Test nhanh kháng nguyên COVID-19", type: "xet-nghiem", subType: "covid", category: ["Xét nghiệm", "COVID"], fee: 150000, img: nmdLogoo, vip: false },
    { id: "XN18", name: "Xét nghiệm PCR COVID-19 (Kết quả trong ngày)", type: "xet-nghiem", subType: "covid", category: ["Xét nghiệm", "COVID"], fee: 700000, img: nmdLogoo, vip: true },
    { id: "XN19", name: "Giải mã GEN tài năng & Thể chất trẻ em", type: "xet-nghiem", subType: "gen", category: ["Xét nghiệm", "Di truyền"], fee: 4500000, img: nmdLogoo, vip: true },
    { id: "XN20", name: "Tầm soát GEN bệnh lý di truyền mãn tính", type: "xet-nghiem", subType: "gen", category: ["Xét nghiệm", "Di truyền"], fee: 8000000, img: nmdLogoo, vip: true },
  ];
